...
st.markdown('''
            **분석1.** 2012 ~ 2017년도의 물가는 계속 상승하는 반면 지출은 감소하고 있다.  
            물가와 지출이 반비례 관계를 가지는 이유는 소비자는 해당 품목의 비용이 증가하면 ‘교육’에 대한 지출을 줄인다는 것을 알 수 있다.  \n
            **분석2.** 교육에 대한 물가지수는 매년 증가하는 추세를 보이다가 2019년에 급락하였다.  
            코로나19로 인해 비교적 저렴한 비대면 교육의 확산으로 물가지수가 감소한 것으로 보인다.  
            따라서 교육 항목은 물가가 상승하면 소비를 줄일 수 있는 항목이며 사회적 이슈에 지출 형태가 달라지는 특성을 가진다.
            ''')
