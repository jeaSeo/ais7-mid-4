...
st.markdown('''
            **분석1.** 소비자 물가지수와 가계지출의 추세가 모두 상승하고 있는 추세이며, 지수의 상승폭과 지출의 상승폭이 비슷하다.  \n
            **분석2.** 2017년 ~ 2021년은 물가지수가 상승을 했고, 가계지출도 다소 상승을 했지만 2015년과 비슷한 수준이다.  
            따라서 소비자 물가가 큰 폭으로 상승하거나 하락하여도 사람들은 소비량을 조절해가며 일정 수준의 지출금액을 맞추려는 경향이 있는 것으로 보인다.  
            ''')
st.markdown('따라서 가정용품 및 가사서비스는 **물가에 민감하지 않은 항목**이다.')
st.markdown(' ')
st.markdown(' ')
st.markdown(' ')
