...
st.markdown('''
            **분석1.** 분석1. 2012년 ~ 2016년, 2019년~2020년에 의류 및 신발 물가가 상승함에 따라 가계지출이 감소하였다.  
            이는 가격이 비싸졌음에도 불구하고 지출금액이 감소하였다는 것은 사람들의 소비량이 감소했다는 것으로 해석할 수 있다.    
            ''')
st.markdown('따라서 의류 및 신발은 **물가에 민감한 항목**이라고 볼 수 있다. ')
st.markdown(' ')
st.markdown(' ')
st.markdown(' ')
