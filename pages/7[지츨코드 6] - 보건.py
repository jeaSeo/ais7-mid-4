...
fig1
st.markdown('- 최종결론: 민감하지 않은 항목이다.')
st.markdown('  - 보건에 대한 소비자물가지수는 지속적으로 상승하는 흐름을 가지고 있습니다.')
st.markdown('  - 2017년부터 횡보하다 2019~2020년 상승이후 다시 횡보하고 있습니다.')
st.markdown('  - 가계지출 또한 지속적 상승의 흐름을 가지고있고 지수의 흐름과 큰차이없이 비슷한 모습을 보입니다.')
st.markdown('  - ~이는 모든 소득계층에서 공통적으로 보이는 틍성입니다.')
st.markdown('  - 따라서 보건은 물가에 민감하지 않은 항목으로 볼 수 있습니다.')