...
st.markdown('''
            **분석1.** 정부정책에 따라 2014년~2015년 물가지수가 급등하였으나 지수가 증가한 정도보다 지출금액이 증가한 정도가 적어보여 가격 인상으로 인해 어느정도 소비량이 줄은 것으로 보인다.
            ''')
st.markdown('따라서 주류 및 담배는 물가에 민감한 항목은 아니나, **물가가 일정 수준 이상으로 급등하면 영향을 받는 항목**으로 보여진다. ')
st.markdown(' ')
st.markdown(' ')
st.markdown(' ')
